"""
Direct Mixing pooling layers for N-stream processing.
"""
...
class _DMMaxPoolNd(Module):
    """
    Direct Mixing MaxPool base class - follows PyTorch's _MaxPoolNd pattern exactly.
...
class DMMaxPool2d(_DMMaxPoolNd):
    r"""Direct Mixing 2D max pooling - follows PyTorch's MaxPool2d pattern exactly.
...
class _DMAdaptiveAvgPoolNd(Module):
    """
    Direct Mixing Adaptive Average Pool base class - follows PyTorch's _AdaptiveAvgPoolNd pattern exactly.
...
class DMAdaptiveAvgPool2d(_DMAdaptiveAvgPoolNd):
    r"""Direct Mixing 2D adaptive average pooling - follows PyTorch's AdaptiveAvgPool2d pattern exactly.

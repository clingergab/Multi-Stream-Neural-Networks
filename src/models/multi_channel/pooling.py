...
class _MCMaxPoolNd(Module):
    ...
    _MaxPoolNd but adapted for dual-stream (stream1/stream2) processing.
    """
...
class MCMaxPool2d(_MCMaxPoolNd):
    ...
    Applies a 2D max pooling over dual input signals (stream1 and stream2 streams)
    ...
    def forward(self, stream1_input: Tensor, stream2_input: Tensor) -> tuple[Tensor, Tensor]:
        ...
        Returns:
            Tuple of (stream1_output, stream2_output) tensors
        """
        # Apply max pooling to stream1 stream
        ...
        # Apply max pooling to stream2 stream
...
class _MCAdaptiveAvgPoolNd(Module):
    ...
    _AdaptiveAvgPoolNd but adapted for dual-stream (stream1/stream2) processing.
    """
...
class MCAdaptiveAvgPool2d(_MCAdaptiveAvgPoolNd):
    ...
    Applies a 2D adaptive average pooling over dual input signals (stream1 and stream2 streams)
    composed of several input planes.
    ...
    def forward(self, stream1_input: Tensor, stream2_input: Tensor) -> tuple[Tensor, Tensor]:
        ...
        Returns:
            Tuple of (stream1_output, stream2_output) tensors
        """
        # Apply adaptive average pooling to stream1 stream
        stream1_output = F.adaptive_avg_pool2d(stream1_input, self.output_size)
        
        # Apply adaptive average pooling to stream2 stream

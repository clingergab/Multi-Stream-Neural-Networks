"""
Core convolution operations used across CNN architectures.

This module provides standard convolution building blocks that form the foundation
of many CNN architectures including ResNet and its variants.
"""
